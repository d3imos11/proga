/*Написать программу
1.	Создать файл AEROFLOT.dat, содержащий  записи следующей структуры:
•	номер рейса самолета; 
•	количество свободных мест.
2.	 программа должна выполнять следующую обработку файла:  по вводимому  с клавиатуры номеру рейса выводит из файла 
сведения о количестве свободных мест на этот рейс.
